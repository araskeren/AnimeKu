                ...
                <form class="" action="" method="post">
                  <div class="row">
                   <div class="input-field col s12">
                     <input id="nama" type="text" name="nama" value="{{$dataUser->nama}}">
                     <label for="nama" class="">Nama</label>
                   </div>
                  </div>
                  <div class="row">
                   <div class="input-field col s12">
                     <input id="username" type="text" name="username" value="{{$dataUser->username}}">
                     <label for="username" class="">Username</label>
                   </div>
                  </div>
                  <div class="row">
                   <div class="input-field col s12">
                     <input id="email" type="email" name="email" value="{{$dataUser->email}}">
                  ...
                  <div class="row">
                    <select id="type-anime" name="role">
                      ...
                      <option value="1">Admin</option>
                      <option value="2">Moderator</option>
                      <option value="3" selected>Premium-User</option>
                      <option value="4">Free-User</option>
                      @elseif($dataUser->level==4)
                      <option value="1">Admin</option>
                      <option value="2">Moderator</option>
                      <option value="3">Premium-User</option>
                      <option value="4" selected>Free-User</option>
                      @endif
                    </select>
                  </div>
                  {{csrf_field()}}
                  <div class="row">
                   <div class="left">
                     <button class="waves-effect waves-light btn-large "><i class="mdi-content-add-circle right"></i>Simpan User</button>
                   </div>
                 </div>
                </form>
            </div>

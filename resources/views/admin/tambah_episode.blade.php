            ...
            <div class="col s12">
              <nav class="red">
                <div class="nav-wrapper">
                  <div class="col s12">
                    <h4 class="left">Tambah Episode <small class="hide-on-small-only">{{$judul}}</small></h4>
                  </div>
                </div>
              </nav>
            </div>
              ...
              <form class="" action="" method="post" enctype="multipart/form-data">
                <div class="row">
                  <div class="input-field col s12 m4 l4">
                    <input name="episode" id="episode" type="number" class="validate" value="{{$episodeSekarang}}">
                ...
                <div class="row">
                  <div class="input-field col s12 m4 l4">
                     <input name="stream[]" id="server1" type="text" class="validate" placeholder="http://">
                     <label for="serverStream1">Link Streaming Server 1</label>
                  </div>
                  <div class="input-field col s12 m4 l4">
                   <input name="stream[]" id="server2" type="text" class="validate" placeholder="http://">
                   <label for="serverStream2">Link Streaming Server 2</label>
                  </div>
                  <div class="input-field col s12 m4 l4">
                    <input name="stream[]" id="server3" type="text" class="validate" placeholder="http://">
                    <label for="serverStream3">Link Streaming Server 3</label>
                  </div>
                </div>
                <div class="row">
                    <div class="input-field col s12 m4 l4">
                     <input name="download[]" id="serverDL1" type="text" class="validate" placeholder="http://">
                     <label for="serverDL1">Link Download Server 1</label>
                    </div>
                    <div class="input-field col s12 m4 l4">
                     <input name="download[]"id="serverDL2" type="text" class="validate" placeholder="http://">
                     <label for="serverDL2">Link Download Server 2</label>
                    </div>
                    <div class="input-field col s12 m4 l4">
                     <input name="download[]" id="serverDL3" type="text" class="validate" placeholder="http://">
                ...
                <div class="row">
                  <div class="input-field col s12">
                    <textarea name="keterangan" id="textarea1" class="materialize-textarea" data-length="120"></textarea>
                    <label for="textarea1">Keterangan Episode</label>
                  </div>
                </div>
                {{csrf_field()}}
                <button type="submit" class="waves-effect waves-light btn-large "><i class="mdi-content-add-circle right"></i>Tambah Episode</button>
              </form>
            </div>
                        ...
                        @if($episodeSekarang>0)
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <a href="/admin/delete/episode/{{$i->id}}" class="modal-trigger"><button class="btn-floating btn-large waves-effect waves-light" type="submit" name="delete" value="1"><i class="mdi-action-delete small"></i></button></a>
                            </td>
                          </tr>
                          @endforeach
                        @endif
